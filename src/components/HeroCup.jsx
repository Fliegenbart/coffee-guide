  ...
  return (
    <div className="flex flex-col items-center animate-fadeIn w-full max-w-sm">
      ...
      <div className="relative flex items-center gap-4">
        ...
        <div className="flex flex-col-reverse justify-end h-44 w-16 text-right">
          {coffee.layers.map((layer, i) => (
            <div
              key={i}
              className="flex items-center justify-end gap-2 transition-all duration-500"
              style={{ height: `${layer.ratio}%`, minHeight: '18px' }}
            >
        ...
        <div className="flex flex-col-reverse justify-end h-44 w-24">
          {coffee.layers.map((layer, i) => (
            <div
              key={i}
      ...
      <div className="mt-5 text-center">
        ...
        <p className="text-stone-500 mt-2 max-w-xs text-sm">{coffee.description[lang]}</p>
      </div>
